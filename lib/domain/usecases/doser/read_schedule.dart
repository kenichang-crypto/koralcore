...
/// - DropInformation.getDetails(headId) returns schedule detail list
/// - Schedule details include time, dose amount, drop times, rotating speed
/// - BLE opcodes 0x68-0x6D retrieve different schedule detail types
