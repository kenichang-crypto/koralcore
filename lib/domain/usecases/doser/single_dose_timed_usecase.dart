...
import '../../doser_dosing/encoder/timed_single_dose_encoder.dart';
...
///
/// PARITY: Corresponds to reef-b-app's timed single dose behavior:
/// - CommandManager.getDropSingleTimelyCommand() -> BLE opcode 0x6F
/// - PumpHeadScheduleViewModel: initiates timed dose with date/time parameters
/// - SingleDripTimedInfo contains year, month, day, hour, minute, ml, rpm
/// - On success: resets schedule, sets mode to single, stores timed info, shows toast
