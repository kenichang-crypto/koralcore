...
import '../../doser_dosing/single_dose_immediate.dart';
...
///
/// PARITY: Corresponds to reef-b-app's immediate single dose behavior:
/// - CommandManager.getDropSingleImmediatelyCommand() -> BLE opcode 0x6E
/// - DropMainViewModel.clickPlayDropHead() -> bleManager.sendDropSingleImmediatelyCommand()
/// - PumpHeadScheduleViewModel: singleDripImmediate() callback handles success/failure
/// - On success: resets schedule, sets mode to single, shows toast
/// - Validates daily limit before sending (dropInformation.getTodayTotalDrop())
