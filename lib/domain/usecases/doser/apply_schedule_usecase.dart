...
import '../../doser_dosing/doser_schedule.dart';
import '../../doser_dosing/doser_schedule_type.dart';
import '../../doser_dosing/pump_head.dart';
import '../../doser_dosing/custom_window_schedule_definition.dart';
import '../../doser_dosing/daily_average_schedule_definition.dart';
import '../../../data/ble/encoder/schedule/custom_schedule_chunk_encoder.dart';
import '../../../data/ble/encoder/schedule/custom_schedule_encoder_0x72.dart';
import '../../../data/ble/encoder/schedule/custom_schedule_encoder_0x73.dart';
import '../../../data/ble/encoder/schedule/custom_schedule_encoder_0x74.dart';
import '../../../data/ble/encoder/schedule/daily_average_schedule_encoder.dart';
import '../../../data/ble/schedule/schedule_sender.dart';
import '../../../data/ble/schedule/h24_schedule_builder.dart';
import '../../../data/ble/schedule/custom_schedule_builder.dart';
import '../../../data/ble/schedule/oneshot_schedule_builder.dart';
...
///
/// PARITY: Corresponds to reef-b-app's schedule application behavior:
/// - DropHeadRecordSettingViewModel: applies 24h/custom schedules via BLE commands
/// - CommandManager.getDrop24WeeklyCommand() -> BLE opcode 0x70 (24h weekly)
/// - CommandManager.getDrop24RangeCommand() -> BLE opcode 0x71 (24h range)
/// - CommandManager.getDropCustomWeeklyCommand() -> BLE opcode 0x72 (custom weekly)
/// - CommandManager.getDropCustomRangeCommand() -> BLE opcode 0x73 (custom range)
/// - CommandManager.getDropCustomDetailCommand() -> BLE opcode 0x74 (custom detail)
