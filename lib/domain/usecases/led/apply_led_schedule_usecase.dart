...
import '../../../data/ble/schedule/led/led_schedule_payload.dart';
import '../../../data/ble/schedule/led/led_schedule_encoder.dart';
...
///
/// PARITY: Corresponds to reef-b-app's LED schedule application:
/// - LedScheduleEditActivity: applies schedule via BLE commands
/// - CommandManager.getLedSetRecordCommand() -> BLE opcode 0x41
/// - Schedule is encoded and sent to device
/// - On success: updates LedInformation, refreshes schedule list, shows toast
