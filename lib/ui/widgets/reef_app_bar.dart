...
class ReefAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const ReefAppBar({
    ...
    this.dividerColor = ReefColors.surfacePressed, // bg_press
  });
    ...
    return Column(
      ...
      children: [
        AppBar(
          ...
          title: title,
          actions: actions,
          backgroundColor: backgroundColor ?? ReefColors.surface, // white
          foregroundColor: foregroundColor ?? ReefColors.textPrimary,
